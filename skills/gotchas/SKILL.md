...
name: gotchas
description: >
  Reference card with the 11 critical Gentoo ebuild gotchas (eapply_user, || die,
  KEYWORDS for 9999, S=, SRC_URI rename, QA_PREBUILT/RESTRICT, header ordering,
  thin-manifests, default in src_prepare, MY_P/MY_PN, stabilize-allarches). Designed to be preloaded
